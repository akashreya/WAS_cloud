...
/**
 * Exception thrown when employee management business rules are violated.
 * 
 * @author akash.kantharaj
 * @version 2.0.0
 */
public class EmployeeException extends WorkspaceAllocationException {
     ...
     */
    public EmployeeException(String errorCode, Object... messageParams) {
     ...
     * @param messageParams parameters for message formatting
     */
    public EmployeeException(String errorCode, Throwable cause, Object... messageParams) {
