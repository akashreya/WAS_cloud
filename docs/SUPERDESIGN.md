# SuperDesign Configuration

This file contains configuration and guidelines for the SuperDesign frontend design system when working with UI components in this project.
